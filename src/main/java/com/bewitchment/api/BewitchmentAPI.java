...
public class BewitchmentAPI {
    ...
    public static boolean hasPets(EntityPlayer entity) {
        return (entity.getCapability(ExtendedPlayer.CAPABILITY, null)).getPets() > 0;
    }
    ...
    public static boolean defeatedBoss(EntityPlayer entity) {
        return !(entity.getCapability(ExtendedPlayer.CAPABILITY, null)).getUniqueDefeatedBosses().isEmpty();
    }
