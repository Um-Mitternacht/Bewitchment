...
public abstract class Fortune extends IForgeRegistryEntry.Impl<Fortune> {
	 ...
	 * 
	 * @param weight
	 *            see {@link #getDrawingWeight()}
	 * @param name
	 *            registry name of the fortune, without the domain
	 * @param modid
	 *            registry domain of the fortune, typically this is the mod id
	 */
	 ...
	 * 
	 * @param player
	 *            the player the fortunes are being read to
