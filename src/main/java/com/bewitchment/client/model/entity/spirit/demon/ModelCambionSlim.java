...
public class ModelCambionSlim extends ModelBiped {
	...
	public ModelCambionSlim() {
		...
		this.upperJaw = new ModelRenderer(this, 23, 41);
		this.upperJaw.setRotationPoint(0.0F, -1.4F, -3.8F);
		...
		this.leftLeg.setRotationPoint(1.9F, 13.0F, 0.0F);
		...
		this.cleft = new ModelRenderer(this, 32, 43);
		...
		this.lowerJaw = new ModelRenderer(this, 23, 46);
		this.lowerJaw.setRotationPoint(0.0F, -0.4F, -3.8F);
		...
		this.rightLeg.setRotationPoint(-1.9F, 13.0F, 0.0F);
		...
		this.lClaws.setRotationPoint(1.4F, 11.5F, 0.0F);
		...
		this.snout.setRotationPoint(0.0F, -2.5F, -3.7F);
		...
		this.skirtFront = new ModelRenderer(this, 0, 42);
		this.skirtFront.setRotationPoint(0.0F, 12.9F, -1.7F);
		this.skirtFront.addBox(-4.5F, -0.1F, -0.5F, 9, 9, 2, 0.0F);
		this.skirtBack = new ModelRenderer(this, 0, 53);
		this.skirtBack.setRotationPoint(0.0F, 12.9F, 0.6F);
		this.skirtBack.addBox(-4.5F, -0.1F, -0.5F, 9, 9, 2, 0.0F);
		this.rClaws = new ModelRenderer(this, 0, 34);
		this.rClaws.mirror = true;
		this.rClaws.setRotationPoint(-1.2F, 11.5F, 0.0F);
		...
		this.leftArm.addChild(this.lClaws);
		...
		this.body.addChild(this.skirtFront);
		this.body.addChild(this.skirtBack);
		this.rightArm.addChild(this.rClaws);
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netheadYaw, float headPitch, float scaleFactor, Entity entity) {
		...
		float swingMod = 0.6F;
		this.leftLeg.rotateAngleX = MathHelper.sin(limbSwing * 0.8665F + (float) Math.PI) * swingMod * limbSwingAmount - 0.26F;
		this.rightLeg.rotateAngleX = MathHelper.cos(limbSwing * 0.8665F) * swingMod * limbSwingAmount - 0.26F;
