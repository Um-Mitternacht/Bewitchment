...
public class ModelDruden extends ModelBase {
	...
	public ModelDruden() {
		...
		this.rightLeg00.setRotationPoint(-2.1F, 8.0F, 0.1F);
		this.rightLeg00.addBox(-2.0F, -1.0F, -2.5F, 4, 8, 5, 0.0F);
		this.setRotateAngle(rightLeg00, -0.2617993877991494F, 0.0F, 0.10471975511965977F);
		...
		this.bipedLeftLeg.setRotationPoint(0.0F, 5.7F, -0.4F);
		this.bipedLeftLeg.addBox(-1.5F, 0.0F, -2.0F, 3, 6, 4, 0.0F);
		this.setRotateAngle(bipedLeftLeg, 0.6981317007977318F, 0.0F, 0.10471975511965977F);
		this.bipedRightLeg = new ModelRenderer(this, 0, 30);
		this.bipedRightLeg.mirror = true;
		this.bipedRightLeg.setRotationPoint(0.0F, 5.7F, -0.4F);
		this.bipedRightLeg.addBox(-1.5F, 0.0F, -2.0F, 3, 6, 4, 0.0F);
		this.setRotateAngle(bipedRightLeg, 0.6981317007977318F, 0.0F, -0.10471975511965977F);
		...
		this.leftLeg00.setRotationPoint(2.1F, 8.0F, 0.1F);
		this.leftLeg00.addBox(-2.0F, -1.0F, -2.5F, 4, 8, 5, 0.0F);
		this.setRotateAngle(leftLeg00, -0.2617993877991494F, 0.0F, -0.10471975511965977F);
		...
		this.lowerBody.addChild(this.rightLeg00);
		this.rightAntler04a.addChild(this.rightAntler04b);
		this.leftLeg00.addChild(this.bipedLeftLeg);
		this.rightLeg00.addChild(this.bipedRightLeg);
		...
		this.lowerBody.addChild(this.leftLeg00);
