 ...
 */
public class ModelMoloch extends ModelBase {
	...
	public ModelMoloch() {
		...
		this.setRotateAngle(leftLeg01, 0.13962634015954636F, 0.0F, 0.06981317007977318F);
		...
		this.setRotateAngle(leftLeg00, -0.10471975511965977F, 0.0F, -0.06981317007977318F);
		...
		this.setRotateAngle(rightLeg01, 0.13962634015954636F, 0.0F, -0.06981317007977318F);
		...
		this.setRotateAngle(rightHoof02, -0.03490658503988659F, 0.10471975511965977F, 0.0F);
		...
		this.setRotateAngle(leftHoof02, -0.03490658503988659F, 0.10471975511965977F, 0.0F);
		...
		this.setRotateAngle(rightHoof01, -0.03490658503988659F, -0.10471975511965977F, 0.0F);
		...
		this.setRotateAngle(leftArm01, -0.17453292519943295F, 0.0F, 0.08726646259971647F);
		...
		this.setRotateAngle(rightArm01, -0.17453292519943295F, 0.0F, -0.08726646259971647F);
		...
		this.cape00 = new ModelRenderer(this, 97, 48);
		this.cape00.setRotationPoint(0.0F, -0.7F, 9.0F);
		this.cape00.addBox(-6.0F, -0.5F, 0.0F, 12, 14, 1, 0.0F);
		this.setRotateAngle(cape00, 0.03490658503988659F, 0.0F, 0.0F);
		...
		this.chest.setRotationPoint(0.0F, -7.4F, 0.0F);
		...
		this.cape02 = new ModelRenderer(this, 0, 58);
		this.cape02.setRotationPoint(0.0F, 9.7F, 0.0F);
		this.cape02.addBox(-5.5F, 0.0F, 0.4F, 11, 5, 0, 0.0F);
		this.setRotateAngle(cape02, 0.13962634015954636F, 0.0F, 0.0F);
		...
		this.cape01 = new ModelRenderer(this, 103, 35);
		this.cape01.setRotationPoint(0.0F, 13.4F, 0.5F);
		this.cape01.addBox(-5.5F, 0.0F, -0.5F, 11, 10, 1, 0.0F);
		this.setRotateAngle(cape01, -0.10471975511965977F, 0.0F, 0.0F);
		...
		this.setRotateAngle(leftHoof01, -0.03490658503988659F, -0.10471975511965977F, 0.0F);
		...
		this.setRotateAngle(rightLeg00, -0.10471975511965977F, 0.0F, 0.06981317007977318F);
		this.loinclothBack = new ModelRenderer(this, 74, 48);
		this.loinclothBack.setRotationPoint(0.0F, 8.9F, 2.9F);
		this.loinclothBack.addBox(-5.0F, 0.0F, -0.5F, 10, 10, 1, 0.0F);
		...
		this.loinclothFront.setRotationPoint(0.0F, 8.9F, -2.1F);
		this.loinclothFront.addBox(-5.0F, 0.0F, -0.5F, 10, 10, 1, 0.0F);
		this.setRotateAngle(loinclothFront, -0.10471975511965977F, 0.0F, 0.0F);
		...
		this.mantle00.addChild(this.cape00);
		...
		this.cape01.addChild(this.cape02);
