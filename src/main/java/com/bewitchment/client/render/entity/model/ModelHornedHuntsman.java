...
public class ModelHornedHuntsman extends ModelBase {
	...
	public ModelHornedHuntsman() {
		...
		this.rAntler01.setRotationPoint(-1.5F, -3.5F, 0.5F);
		...
		this.backFur.setRotationPoint(0.0F, -7.6F, 3.0F);
		...
		this.boobs = new ModelRenderer(this, 19, 50);
		this.boobs.setRotationPoint(0.0F, -4.7F, -1.0F);
		this.boobs.addBox(-4.0F, -2.0F, -3.0F, 8, 5, 4, 0.0F);
		this.setRotateAngle(boobs, -0.2792526803190927F, 0.0F, 0.0F);
		...
		this.bipedLeftLeg.setRotationPoint(2.2F, 1.6F, 0.6F);
		...
		this.rArm02.addBox(-1.5F, 0.0F, -2.0F, 3, 12, 4, 0.0F);
		...
		this.bipedLeftArm.setRotationPoint(5.0F, -11.5F, -1.0F);
		this.bipedLeftArm.addBox(-1.3F, -2.0F, -2.5F, 4, 9, 5, 0.0F);
		this.setRotateAngle(bipedLeftArm, 0.13962634015954636F, 0.0F, -0.15707963267948966F);
		...
		this.mossMantle = new ModelRenderer(this, 89, 44);
		this.mossMantle.setRotationPoint(0.0F, -8.3F, 0.0F);
		this.mossMantle.addBox(-5.0F, 0.0F, -3.8F, 10, 6, 9, 0.0F);
		this.setRotateAngle(mossMantle, -0.19198621771937624F, 0.0F, 0.0F);
		...
		this.lLeg02.setRotationPoint(0.0F, 7.3F, -0.7F);
		this.lLeg02.addBox(-1.5F, 0.0F, -2.0F, 3, 8, 4, 0.0F);
		this.setRotateAngle(lLeg02, 0.6981317007977318F, 0.0F, 0.08726646259971647F);
		...
		this.bipedBody.setRotationPoint(0.0F, 0.5F, 0.5F);
		this.bipedBody.addBox(-4.0F, -6.5F, -2.5F, 8, 8, 5, 0.0F);
		this.setRotateAngle(bipedBody, 0.05235987755982988F, 0.0F, 0.0F);
		...
		this.lMoss.addBox(-0.8F, -0.7F, -3.0F, 4, 5, 6, 0.0F);
		...
		this.rMoss.addBox(-3.2F, -0.7F, -3.0F, 4, 5, 6, 0.0F);
		this.lAntler01 = new ModelRenderer(this, 107, 0);
		this.lAntler01.setRotationPoint(1.5F, -3.5F, 0.5F);
		...
		this.lArm02.addBox(-1.5F, 0.0F, -2.0F, 3, 12, 4, 0.0F);
		...
		this.bipedHead.setRotationPoint(0.0F, -12.9F, -1.0F);
		this.bipedHead.addBox(-3.5F, -3.7F, -3.0F, 7, 4, 6, 0.0F);
		this.setRotateAngle(bipedHead, 0.3665191429188092F, 0.0F, 0.0F);
		...
		this.setRotateAngle(moss01, -0.3665191429188092F, 0.0F, 0.0F);
		...
		this.setRotateAngle(neck01, 0.2617993877991494F, 0.0F, 0.0F);
		this.rLeg02 = new ModelRenderer(this, 0, 34);
		this.rLeg02.mirror = true;
		this.rLeg02.setRotationPoint(0.0F, 7.3F, -0.7F);
		this.rLeg02.addBox(-1.5F, 0.0F, -2.0F, 3, 8, 4, 0.0F);
		this.setRotateAngle(rLeg02, 0.6981317007977318F, 0.0F, -0.08726646259971647F);
		...
		this.bipedRightArm.setRotationPoint(-5.0F, -11.5F, -1.0F);
		this.bipedRightArm.addBox(-2.7F, -2.0F, -2.5F, 4, 9, 5, 0.0F);
		this.setRotateAngle(bipedRightArm, 0.13962634015954636F, 0.0F, 0.15707963267948966F);
		this.bipedRightLeg = new ModelRenderer(this, 0, 16);
		this.bipedRightLeg.mirror = true;
		this.bipedRightLeg.setRotationPoint(-2.2F, 1.6F, 0.6F);
		...
		this.chest.addBox(-4.5F, -8.0F, -3.5F, 9, 8, 7, 0.0F);
