...
public class ModelMasterLeonard extends ModelBase {
	...
	public ModelMasterLeonard() {
		...
		this.snout.addBox(-1.5F, -1.0F, -4.7F, 3, 2, 5, 0.0F);
		...
		this.bipedRightArm.setRotationPoint(-4.8F, -0.6F, 0.0F);
		...
		this.muzzleUpper.addBox(-2.0F, -1.8F, -3.5F, 4, 2, 4, 0.0F);
		...
		this.setRotateAngle(bipedHead, 0.06981317007977318F, 0.0F, 0.0F);
		...
		this.bipedLeftArm.setRotationPoint(4.8F, -0.6F, -0.0F);
