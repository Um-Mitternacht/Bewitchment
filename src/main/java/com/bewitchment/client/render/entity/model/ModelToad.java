...
public class ModelToad extends ModelBase {
	...
	public ModelToad() {
		...
		ModelHelper.setRotateAngle(rArm01, -0.8196066167365371F, 0.0F, 0.27314402793711257F);
		...
		ModelHelper.setRotateAngle(lArm02, 0.4553564018453205F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(rLeg03, 0.40980330836826856F, 0.31869712141416456F, 0.0F);
		...
		ModelHelper.setRotateAngle(rLeg01, -0.5009094953223726F, 0.0F, 0.18203784098300857F);
		...
		ModelHelper.setRotateAngle(lLeg01, -0.5009094953223726F, 0.0F, -0.18203784098300857F);
		...
		ModelHelper.setRotateAngle(rLeg02, 0.4553564018453205F, -0.136659280431156F, -0.18203784098300857F);
		...
		ModelHelper.setRotateAngle(lArm01, -0.8196066167365371F, 0.0F, -0.27314402793711257F);
		...
		ModelHelper.setRotateAngle(rArm02, 0.4553564018453205F, 0.0F, 0.0F);
		this.lEye = new ModelRenderer(this, 27, 0);
		this.lEye.setRotationPoint(1.3F, -0.5F, -2.3F);
		this.lEye.addBox(0.0F, -2.1F, -1.5F, 2, 2, 3, 0.0F);
		ModelHelper.setRotateAngle(lEye, 0.0F, 0.18203784098300857F, 0.136659280431156F);
		...
		ModelHelper.setRotateAngle(rEye, 0.0F, -0.18203784098300857F, -0.136659280431156F);
		...
		ModelHelper.setRotateAngle(rHand, 0.7285004297824331F, -0.091106186954104F, -0.4553564018453205F);
		...
		ModelHelper.setRotateAngle(lLeg02, 0.4553564018453205F, 0.136659280431156F, 0.18203784098300857F);
		...
		ModelHelper.setRotateAngle(stomach, -0.36425021489121656F, 0.0F, 0.0F);
		...
		ModelHelper.setRotateAngle(lHand, 0.7285004297824331F, 0.091106186954104F, 0.4553564018453205F);
