...
public class RenderTileEntityJuniperChest extends TileEntitySpecialRenderer<TileEntityJuniperChest> {
    private static final ResourceLocation TEX = new ResourceLocation(Bewitchment.MODID, "textures/blocks/juniper_chest.png");
    private final ModelChest model = new ModelChest();

    @Override
    public void render(TileEntityJuniperChest tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        int i = 0;
