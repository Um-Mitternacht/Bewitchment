...
public class BlockPoppetShelf extends ModBlockContainer {
    private static final AxisAlignedBB BOX_S = new AxisAlignedBB(0, 0, 0, 1, 1, 4 / 16d),
            BOX_E = new AxisAlignedBB(0, 0, 0, 4 / 16d, 1, 1),
            BOX_N = new AxisAlignedBB(0, 0, 1, 1, 1, 12 / 16d),
            BOX_W = new AxisAlignedBB(1, 0, 0, 12 / 16d, 1, 1);
