...
public class CauldronRegistry {
	...
	public static void init() { // TODO: Tune values. Also call for oredicts where possible. Such things have been marked with todos.
		...
		registerCauldronItemCrafting(Fluids.MUNDANE_OIL, new ItemStack(ModItems.ritual_chalk, 1, 3), normalRitualChalk, blazePowder, blazePowder, fumeFieryBreeze);
		registerCauldronItemCrafting(FluidRegistry.WATER, new ItemStack(ModItems.ritual_chalk, 1, 2), normalRitualChalk, dimensionalSand, dimensionalSand, fumeHeavenlyWind);
		registerCauldronItemCrafting(Fluids.HONEY, new ItemStack(ModItems.ritual_chalk, 1, 1), normalRitualChalk, goldNugget, goldNugget, fumeCleansingAura);
