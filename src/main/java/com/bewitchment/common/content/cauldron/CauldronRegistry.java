...
public class CauldronRegistry {
	...
	public static void init() { // TODO: Tune values. Also call for oredicts where possible. Such things have been marked with todos.
		...
		registerCauldronItemCrafting(Fluids.MUNDANE_OIL, new ItemStack(ModItems.ritual_chalk_nether), normalRitualChalk, blazePowder, blazePowder, fumeFieryBreeze);
		registerCauldronItemCrafting(FluidRegistry.WATER, new ItemStack(ModItems.ritual_chalk_ender), normalRitualChalk, dimensionalSand, dimensionalSand, fumeHeavenlyWind);
		registerCauldronItemCrafting(Fluids.HONEY, new ItemStack(ModItems.ritual_chalk_golden), normalRitualChalk, goldNugget, goldNugget, fumeCleansingAura);
