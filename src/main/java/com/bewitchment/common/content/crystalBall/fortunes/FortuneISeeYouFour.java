...
public class FortuneISeeYouFour extends Fortune {

	public FortuneISeeYouFour(int weight, String name, String modid) {
	...
	public boolean apply(EntityPlayer player) {
		for (int i = 0; i < 10; i++) {
			...
			EntityDemoness demon = new EntityDemoness(player.world);
