...
public class ModRituals {
	...
	public static void init() {
		...
		call_of_the_wild = new RitualCallOfTheWild(rl("call_of_the_wild"), of(LibIngredients.fumeBirchSoul, LibIngredients.oakAppleGall, LibIngredients.fumeBottledMagic, LibIngredients.chrysanthemum, LibIngredients.anyLeaf), none, 135, circles(ANY, ANY, ANY), 1050, 3);
		registerAll();
	}
