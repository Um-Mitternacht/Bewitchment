...
public class RitualConjurationHellhound extends RitualImpl {

	public RitualConjurationHellhound(ResourceLocation registryName, NonNullList<Ingredient> input, NonNullList<ItemStack> output, int timeInTicks, int circles, int altarStartingPower, int powerPerTick) {
