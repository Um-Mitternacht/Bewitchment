...
public class EntityOwl extends EntityRaven {
	...
	protected void initEntityAI() {
		...
		targetTasks.addTask(2, new EntityAITargetNonTamed<>(this, EntityLivingBase.class, false, e -> e instanceof EntityBat || e instanceof EntityChicken || e instanceof EntityLizard || e instanceof EntityParrot || e instanceof EntityRabbit || e.getClass().getName().equals("seraphaestus.historicizedmedicine.Mob.Rat.EntityRat") ||  e.getClass().getName().equals("alexthe666.rats.server.entity.EntityRat")));
	}
}