...
public class EntitySnake extends ModEntityTameable {
	...
	protected void initEntityAI() {
		...
		targetTasks.addTask(3, new EntityAITargetNonTamed<>(this, EntityLivingBase.class, false, e -> e instanceof EntityChicken || e instanceof EntityLizard || e instanceof EntityRabbit || e instanceof EntityParrot || e.getClass().getName().equals("seraphaestus.historicizedmedicine.Mob.Rat.EntityRat") ||  e.getClass().getName().equals("com.github.alexthe666.rats.server.entity.EntityRat")));
	}
