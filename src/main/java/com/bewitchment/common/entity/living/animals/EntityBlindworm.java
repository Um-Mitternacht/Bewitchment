...
public class EntityBlindworm extends EntityFamiliar {
	...
	private static final DataParameter<Integer> TINT = EntityDataManager.createKey(EntityBlindworm.class, DataSerializers.VARINT);
	...
	public boolean canMateWith(EntityAnimal otherAnimal) {
		if (otherAnimal == this) {
			...
			if (!entityblindworm.isTamed()) {
				return false;
			} else if (entityblindworm.isSitting()) {
				return false;
			} else {
