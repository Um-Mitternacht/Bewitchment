...
public class EntityOwl extends EntityFamiliar {
	...
	public static boolean isOwlFodder(Entity entity) {
		...
		return entity instanceof EntityRabbit || entity instanceof EntityBat || entity instanceof EntityChicken || entity instanceof EntityParrot || className.contains("Rat") || className.contains("Hedgehog") || className.contains("Hamster") || className.contains("Squirrel") || className.contains("Hare") || className.contains("Fox") || className.contains("Pigeon") || className.contains("Turkey") || className.contains("Mouse") || className.contains("Bat") || className.contains("Lizard") || className.contains("Frog") || className.contains("Toad") || className.contains("Snake") || className.contains("Beetle") || className.contains("Chinchilla") || className.contains("Cavy") || className.contains("GuineaPig") || className.contains("Crow") || className.contains("Raven") || className.contains("Rooster") || className.contains("Hen") || className.contains("Chick") || className.contains("Mole") || className.contains("Deer") || className.contains("Ferret") || className.contains("Chinchilla");
	}
