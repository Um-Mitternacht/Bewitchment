...
/**
 * Created by Joseph on 5/21/2019.
 */
public class ModBlockChisel extends ModBlock {
	...
	public ModBlockChisel(String name, Block base) {
		...
		Util.registerBlock(this, base.getTranslationKey().substring(6 + Bewitchment.MODID.length()) + "_" + name, base, Util.toArray(base instanceof IOreDictionaryContainer ? ((IOreDictionaryContainer) base).getOreDictionaryNames() : Arrays.asList("")));
