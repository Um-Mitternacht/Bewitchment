...
public class ThaumcraftCompat implements IConditionFactory {
	public static final Aspect SUN = getOrCreateAspect("sol", 0xffd300, new Aspect[]{Aspect.FIRE, Aspect.LIGHT}, Util.newResource("textures/thaumcraft/sol.png"));
	public static final Aspect MOON = getOrCreateAspect("luna", 0x808080, new Aspect[]{Aspect.EARTH, Aspect.DARKNESS}, Util.newResource("textures/thaumcraft/luna.png"));
	public static final Aspect STAR = getOrCreateAspect("stellae", 0x73c2fb, new Aspect[]{SUN, Aspect.VOID}, Util.newResource("textures/thaumcraft/stellae.png"));
	public static final Aspect DEMON = getOrCreateAspect("diabolus", 0x960018, new Aspect[]{Aspect.SOUL, Aspect.AVERSION}, Util.newResource("textures/thaumcraft/diabolus.png"));

	//TODO: NEW ICON FOR SPIRITUAL_WARD
	public static final EnumGolemTrait SPIRITUAL_WARD = EnumHelper.addEnum(EnumGolemTrait.class, "SPIRITUAL_WARD", new Class[]{ResourceLocation.class}, Util.newResource("textures/thaumcraft/golems/tag_blessed.png"));
	public static final EnumGolemTrait UNCANNY = EnumHelper.addEnum(EnumGolemTrait.class, "UNCANNY", new Class[]{ResourceLocation.class}, Util.newResource("textures/thaumcraft/golems/tag_uncanny.png"));
	public static final EnumGolemTrait BLESSED = EnumHelper.addEnum(EnumGolemTrait.class, "BLESSED", new Class[]{ResourceLocation.class}, Util.newResource("textures/thaumcraft/golems/tag_blessed.png"));

	public static void init() {
		ThaumcraftApi.registerResearchLocation(Util.newResource("tc/research/bewitchment"));
	...
	public void handleGolems(@NotNull LivingHurtEvent event) {
		...
		if (!target.world.isRemote) {
			...
			if (source instanceof EntityLivingBase) {
				...
				float damage = getDamage(event.getAmount(), BewitchmentAPI.SILVER_WEAKNESS, target, attacker, isSilverGolem(attacker), isSilverGolem(target));
	...
	public void aspectRegistrationEvent(AspectRegistryEvent event) {
		...
		//Equipment
		register.registerObjectTag(new ItemStack(ModObjects.girdle_of_the_dryads), new AspectList().add(Aspect.PLANT, 20).add(Aspect.LIFE, 20).add(Aspect.PROTECT, 20).add(Aspect.MAGIC, 20));
		...
		register.registerObjectTag(new ItemStack(ModObjects.stew_of_the_grotesque), new AspectList().add(DEMON, 3).add(Aspect.MAGIC, 3).add(Aspect.SENSES, 3).add(MOON, 3));
		//Mob Drops
		...
		register.registerObjectTag(new ItemStack(ModObjects.garlic_grilled), new AspectList().add(Aspect.PLANT, 2).add(Aspect.SENSES, 2).add(Aspect.CRAFT, 2));
		...
		register.registerObjectTag(new ItemStack(Blocks.DOUBLE_PLANT, 1, 0), new AspectList().add(Aspect.PLANT, 5).add(Aspect.SENSES, 5).add(SUN, 3).add(Aspect.AIR, 1).add(Aspect.LIFE, 1));
		register.registerObjectTag(new ItemStack(Items.GOLD_INGOT), new AspectList().add(Aspect.METAL, 10).add(Aspect.DESIRE, 10).add(SUN, 5));
