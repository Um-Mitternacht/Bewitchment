...
public class ThaumcraftCompat {
	...
	public static void init() {
		...
		GolemMaterial.register(new GolemMaterial("SILVER", new String[]{"MATSTUDSILVER"}, new ResourceLocation("bewitchment", "textures/entity/silvergolem.png"), 4786944, 14, 3, 2, new ItemStack(ModObjects.silver_ingot, 6), new ItemStack(ItemsTC.mechanismSimple), new EnumGolemTrait[]{EnumGolemTrait.LIGHT, BLESSED}));
	}
