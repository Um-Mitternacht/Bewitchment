	...
	public ItemStack onItemUseFinish(ItemStack stack, World worldIn, EntityLivingBase living) {
		...
		if (entityplayer != null) {
			if (!entityplayer.world.isRemote) {
				...
				if (rand.nextDouble() < 0.8) entityplayer.addPotionEffect(new PotionEffect(Objects.requireNonNull(getPotionById(17)), 200, 1));
			...
			if (!entityplayer.isCreative()) {
				Util.giveAndConsumeItem(entityplayer, EnumHand.MAIN_HAND, new ItemStack(Items.GLASS_BOTTLE));
			}
		}
