...
public final class LibMod {
	...
	//Dependency
	public static final String DEPENDENCIES = "required-after:forge@[14.23.2.2611,];required-after:JEI@[4.8.5.138,];required-after:Waila@[1.8.24-B39_1.12,];required-after:baubles@[1.5.2,];required-after:craftstudioapi@[0.3.0,]";
