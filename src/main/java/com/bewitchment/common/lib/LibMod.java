...
public final class LibMod {
	...
	//Dependency
	public static final String DEPENDENCIES = "required-after:forge@[14.23.3.2655,];after:JEI@[4.9.1.168,];after:Waila@[1.8.24-B39_1.12,];required-after:baubles@[1.5.2,]";
