...
public class PotionMending extends ModPotion {
	...
	public void affectEntity(Entity source, Entity indirectSource, EntityLivingBase living, int amplifier, double health) {
		...
		if (living.getCreatureAttribute() != EnumCreatureAttribute.UNDEAD && living.getCreatureAttribute() != BewitchmentAPI.DEMON && living.getCreatureAttribute() != BewitchmentAPI.SPIRIT) living.heal(6 * (amplifier + 1));
	}
