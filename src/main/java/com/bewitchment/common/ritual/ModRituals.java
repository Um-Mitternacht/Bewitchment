...
public class ModRituals {
	...
	public static void init() {
		...
		elder_broom = new RitualImpl(rl("elder_broom"), of(Ingredient.fromStacks(new ItemStack(ModBlocks.log_elder, 1, 0)), (Ingredient.fromItem(ModItems.broom)), (Ingredient.fromStacks(new ItemStack(ModBlocks.sapling, 1, 0))), Ingredient.fromStacks(new ItemStack(Blocks.DIRT, 1, 0))), ofs(new ItemStack(ModBlocks.sacrosanct_ground)), 130, circles(NORMAL, NORMAL, null), 1000, 4);
		registerAll();
	}
