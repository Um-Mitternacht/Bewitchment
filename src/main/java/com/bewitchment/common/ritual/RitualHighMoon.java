...
public class RitualHighMoon extends Ritual {
	public RitualHighMoon() {
		super(new ResourceLocation(Bewitchment.MODID, "high_moon"), Arrays.asList(Util.get("ingotSilver"), Util.get(Items.NETHERBRICK), Util.get(ModObjects.hellebore)), null, null, 6, 800, 0, BlockGlyph.NORMAL, -1, -1);
	}
