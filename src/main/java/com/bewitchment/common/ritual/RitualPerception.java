...
public class RitualPerception extends Ritual {
	public RitualPerception() {
		super(new ResourceLocation(Bewitchment.MODID, "perception"), Arrays.asList(Util.get("glowstone"), Util.get(Items.GOLDEN_CARROT)), null, null, -1, 500, 25, BlockGlyph.NORMAL, BlockGlyph.NORMAL, BlockGlyph.NORMAL);
	}
