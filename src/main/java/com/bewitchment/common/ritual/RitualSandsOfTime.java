...
public class RitualSandsOfTime extends Ritual {
	public RitualSandsOfTime() {
		super(new ResourceLocation(Bewitchment.MODID, "sands_of_time"), Arrays.asList(Util.get("sand"), Util.get("oreDiamond")), null, null, -1, 750, 50, BlockGlyph.NORMAL, BlockGlyph.NORMAL, BlockGlyph.NORMAL);
	}
