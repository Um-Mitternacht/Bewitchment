...
public class RitualSolarGlory extends Ritual {
	public RitualSolarGlory() {
		super(new ResourceLocation(Bewitchment.MODID, "solar_glory"), Arrays.asList(Util.get("ingotGold"), Util.get(Items.NETHERBRICK), Util.get(new ItemStack(Blocks.YELLOW_FLOWER, 1, BlockFlower.EnumFlowerType.DANDELION.getMeta()))), null, null, 15, 1000, 0, BlockGlyph.NORMAL, -1, -1);
	}
