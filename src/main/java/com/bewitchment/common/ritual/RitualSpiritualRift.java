...
public class RitualSpiritualRift extends Ritual {
	public RitualSpiritualRift() {
		super(new ResourceLocation(Bewitchment.MODID, "spiritual_rift"), Arrays.asList(Util.get("cropWormwood"), Util.get("cropWormwood"), Util.get(ModObjects.ectoplasm), Util.get(ModObjects.ectoplasm), Util.get(ModObjects.spectral_dust), Util.get("enderpearl")), null, null, true, 15, 1250, 66, BlockGlyph.ENDER, BlockGlyph.ENDER, -1);
	}
