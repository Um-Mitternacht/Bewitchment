...
public class VillagerAlchemistHandler {
    ...
    public static void initAlchemistTrades() {
        ...
        career_alchemist.addTrade(4,
                new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.demonic_elixir), new EntityVillager.PriceInfo(3, 6), new EntityVillager.PriceInfo(1, 2)),
        ...
        career_alchemist.addTrade(5,
                new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.dragons_blood_sapling), new EntityVillager.PriceInfo(2, 4), new EntityVillager.PriceInfo(1, 1)));
    }
}
