...
public class VillagerTradeHandler {
	...
	public void init() {
		hedgewitch = new VillagerRegistry.VillagerProfession(Bewitchment.MODID + ":hedge_witch", Bewitchment.MODID + ":textures/entity/villager_greenwitch.png", Bewitchment.MODID + ":textures/entity/villager_zombie_greenwitch.png");
		{
			...
			career_witch.addTrade(1, new TradeHandler.EmeraldforItemstack(new ItemStack(ModObjects.tallow), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(6, 10)), new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.empty_jar), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)), new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.juniper_berries), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)), new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.elderberries), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)), new TradeHandler.RandomSeedsforEmeralds(new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(2, 5)), new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.oak_apple_gall), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)));
			career_witch.addTrade(2, new TradeHandler.RandomSaplingsforEmeralds(new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(2, 3)), new TradeHandler.RandomSeedsforEmeralds(new EntityVillager.PriceInfo(4, 6), new EntityVillager.PriceInfo(2, 5)));
			career_witch.addTrade(3, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.ravens_feather), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(5, 10)), new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.owlets_wing), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(3, 5)), new TradeHandler.EmeraldforItemstack(new ItemStack(ModObjects.wood_ash), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(10, 20)), new TradeHandler.RandomWeaponsforEmeralds(new EntityVillager.PriceInfo(3, 7)), new TradeHandler.RandomSeedsforEmeralds(new EntityVillager.PriceInfo(6, 7), new EntityVillager.PriceInfo(3, 10)));
		...
		demon = new VillagerRegistry.VillagerProfession("bewitchment:demon", "minecraft:textures/entity/zombie_villager/zombie_farmer.png", "minecraft:textures/entity/zombie_villager/zombie_farmer.png");
		{
			...
			career.addTrade(4, new TradeHandler.RandomStatueForDemon());
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.fortunes_favor), new EntityVillager.PriceInfo(1, 15)));
			career.addTrade(5, new TradeHandler.RandomContractForDemon());
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.gluttons_sash), new EntityVillager.PriceInfo(1, 1)));
		...
		}
		{
			...
			career.addTrade(5, new TradeHandler.RandomContractForDemon());
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.vampiric_amulet), new EntityVillager.PriceInfo(1, 1)));
		...
		}
		{
			...
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.skeleton_key), new EntityVillager.PriceInfo(1, 1)));
			career.addTrade(5, new TradeHandler.RandomIdolForDemon(), new TradeHandler.RandomStatueForDemon(), new TradeHandler.RandomContractForDemon());
		}
	}
}
