...
public class VillagerTradeHandler {
	...
	public void init() {
		hedgewitch = new VillagerRegistry.VillagerProfession(Bewitchment.MODID + ":hedge_witch", Bewitchment.MODID + ":textures/entity/villager_greenwitch.png", Bewitchment.MODID + ":textures/entity/villager_zombie_greenwitch.png");
		{
			...
			career_witch.addTrade(1, new TradeHandler.EmeraldforItemstack(new ItemStack(ModObjects.tallow), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(6, 10)),
					new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.empty_jar), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)),
					new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.juniper_berries), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)),
					new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.elderberries), new EntityVillager.PriceInfo(1, 2), new EntityVillager.PriceInfo(3, 5)));
			...
			career_witch.addTrade(3, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.ravens_feather), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(5, 10)),
					new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.owlets_wing), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(3, 5)),
					new TradeHandler.EmeraldforItemstack(new ItemStack(ModObjects.wood_ash), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(10, 20)),
					new TradeHandler.RandomWeaponsforEmeralds(new EntityVillager.PriceInfo(3, 7)));
			career_witch.addTrade(4, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.heart), new EntityVillager.PriceInfo(3, 6), new EntityVillager.PriceInfo(1, 2)),
		...
		alchemist = new VillagerRegistry.VillagerProfession(Bewitchment.MODID + ":alchemist", Bewitchment.MODID + ":textures/entity/villager_alchemist.png", Bewitchment.MODID + ":textures/entity/villager_alchemist_zombie.png");
		{
			...
			career_alchemist.addTrade(1, new TradeHandler.ItemstackForEmerald(new ItemStack(Items.GLASS_BOTTLE), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(5, 9)),
			...
			career_alchemist.addTrade(2, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.stone_ichor), new EntityVillager.PriceInfo(2, 4), new EntityVillager.PriceInfo(1, 3)),
			...
			career_alchemist.addTrade(3, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.dragons_blood_resin), new EntityVillager.PriceInfo(3, 5), new EntityVillager.PriceInfo(3, 5)),
					...
					new TradeHandler.EmeraldforItemstack(new ItemStack(ModObjects.garnet), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(2, 5)));
			career_alchemist.addTrade(4, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.demonic_elixir), new EntityVillager.PriceInfo(3, 6), new EntityVillager.PriceInfo(1, 2)),
					new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.cleansing_balm), new EntityVillager.PriceInfo(3, 6), new EntityVillager.PriceInfo(1, 3)));
