...
public class VillagerTradeHandler {
	...
	public void init() {
		...
		demon = new VillagerRegistry.VillagerProfession("bewitchment:demon", "minecraft:textures/entity/zombie_villager/zombie_farmer.png", "minecraft:textures/entity/zombie_villager/zombie_farmer.png");
		{
			...
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.gluttons_sash), new EntityVillager.PriceInfo(1, 40)));
		...
		}
		{
			...
			career.addTrade(5, new TradeHandler.RandomContractForDemon());
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.vampiric_amulet), new EntityVillager.PriceInfo(1, 40)));
		...
		}
		{
			...
			career.addTrade(5, new TradeHandler.ItemsForDemon(new ItemStack(ModObjects.skeleton_key), new EntityVillager.PriceInfo(1, 40)));
