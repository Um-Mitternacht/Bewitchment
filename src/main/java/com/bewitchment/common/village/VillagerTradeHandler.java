...
public class VillagerTradeHandler {
	...
	public void init() {
		hedgewitch = new VillagerRegistry.VillagerProfession(Bewitchment.MODID + ":hedge_witch", Bewitchment.MODID + ":textures/entity/villager_greenwitch.png", Bewitchment.MODID + ":textures/entity/villager_zombie_greenwitch.png");
		{
			...
			career_witch.addTrade(2, new TradeHandler.RandomSaplingsforEmeralds(new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(2, 3)), new TradeHandler.RandomSeedsforEmeralds(new EntityVillager.PriceInfo(3, 5), new EntityVillager.PriceInfo(2, 5)));
			career_witch.addTrade(3, new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.ravens_feather), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(5, 10)), new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.owlets_wing), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(3, 5)), new TradeHandler.EmeraldforItemstack(new ItemStack(ModObjects.wood_ash), new EntityVillager.PriceInfo(1, 3), new EntityVillager.PriceInfo(10, 20)), new TradeHandler.RandomWeaponsforEmeralds(new EntityVillager.PriceInfo(3, 7)), new TradeHandler.RandomSeedsforEmeralds(new EntityVillager.PriceInfo(3, 5), new EntityVillager.PriceInfo(2, 5)));
			...
			career_witch.addTrade(5, new TradeHandler.RandomBaublesforEmeralds(new EntityVillager.PriceInfo(8, 16)), new TradeHandler.RandomSeedsforEmeralds(new EntityVillager.PriceInfo(3, 5), new EntityVillager.PriceInfo(2, 5)), (new TradeHandler.ItemstackForEmerald(new ItemStack(ModObjects.thyrsus), new EntityVillager.PriceInfo(3, 12), new EntityVillager.PriceInfo(1, 1))));
		}
