...
public class ModWorldGen implements IWorldGenerator {
	...
	public void generate(Random rand, int chunkX, int chunkZ, World world, IChunkGenerator generator, IChunkProvider provider) {
		if (Arrays.asList(ModConfig.worldGen.worldGenWhitelist).contains(world.provider.getDimension())) {
			...
			if (biomeResource != null && !Arrays.asList(ModConfig.worldGen.treeGen.treeGenBlacklist).contains(biomeResource.getPath())) {
				if (!Loader.isModLoaded("dynamictrees") || !DynamicTreesCompat.replaceWorldGen()) {
					generateTree(world, rand, cypressTree, ModObjects.cypress_sapling, chunkX, chunkZ, ModConfig.worldGen.treeGen.cypressChance, b -> BiomeDictionary.hasType(b, BiomeDictionary.Type.FOREST) && (BiomeDictionary.hasType(b, BiomeDictionary.Type.COLD) || BiomeDictionary.hasType(b, BiomeDictionary.Type.SPOOKY) || BiomeDictionary.hasType(b, BiomeDictionary.Type.CONIFEROUS) || BiomeDictionary.hasType(b, BiomeDictionary.Type.SWAMP) || !BiomeDictionary.hasType(b, BiomeDictionary.Type.WASTELAND)));
					generateTree(world, rand, elderTree, ModObjects.elder_sapling, chunkX, chunkZ, ModConfig.worldGen.treeGen.elderChance, b -> BiomeDictionary.hasType(b, BiomeDictionary.Type.FOREST) && !BiomeDictionary.hasType(b, BiomeDictionary.Type.COLD) && !BiomeDictionary.hasType(b, BiomeDictionary.Type.HOT) || !BiomeDictionary.hasType(b, BiomeDictionary.Type.WASTELAND));
					generateTree(world, rand, juniperTree, ModObjects.juniper_sapling, chunkX, chunkZ, ModConfig.worldGen.treeGen.juniperChance, b -> BiomeDictionary.hasType(b, BiomeDictionary.Type.SAVANNA) || BiomeDictionary.hasType(b, BiomeDictionary.Type.MAGICAL) || BiomeDictionary.hasType(b, BiomeDictionary.Type.MOUNTAIN) || !BiomeDictionary.hasType(b, BiomeDictionary.Type.WASTELAND));
				}
		...
		if (ModConfig.worldGen.enableStructures && world.provider.getDimension() == 0) {
			...
			generateStructure(cambionhome, world, rand, ModConfig.worldGen.structureGen.cambionHomeChance, chunkX, chunkZ, b -> BiomeDictionary.hasType(b, BiomeDictionary.Type.PLAINS) || BiomeDictionary.hasType(b, BiomeDictionary.Type.FOREST) || BiomeDictionary.hasType(b, BiomeDictionary.Type.SPOOKY) || BiomeDictionary.hasType(b, BiomeDictionary.Type.MAGICAL) || b == Biomes.TAIGA || b == Biomes.COLD_TAIGA || b == Biomes.REDWOOD_TAIGA);
		}
	}
