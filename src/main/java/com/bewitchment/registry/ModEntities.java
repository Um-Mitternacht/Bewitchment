...
public class ModEntities {
	...
	public static final EntityEntry ghost = createEntityEntry(EntityGhost.class, "ghost", 0x000000, 0x000000, EnumCreatureType.MONSTER, ModConfig.mobSpawns.ghost.ghostWeight, ModConfig.mobSpawns.ghost.ghostMin, ModConfig.mobSpawns.ghost.ghostMax, Arrays.asList(ModConfig.mobSpawns.ghost.ghostBiomes));
