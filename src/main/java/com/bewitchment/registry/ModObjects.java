...
import com.bewitchment.common.item.fume.*;
...
public class ModObjects {
	...
	public static final Item empty_jar = new ItemEmptyJar();
	public static final Item oak_spirit = new ItemOakSpirit();
	public static final Item spruce_heart = new ItemSpruceHeart();
	public static final Item birch_soul = new ItemBirchSoul();
	public static final Item cloudy_oil = new ItemCloudyOil();
	public static final Item acacia_resin = new ItemAcaciaResin();
	public static final Item ebb_of_death = new ItemEbbDeath();
	public static final Item droplet_of_wisdom = new ItemDropletWisdom();
	public static final Item liquid_witchcraft = new ItemLiquidWitchcraft();
	public static final Item essence_of_vitality = new ItemEssenceVitality();
	//Distillery
