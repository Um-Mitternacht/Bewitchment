...
import com.bewitchment.common.world.gen.tree.*;
...
public class ModObjects {
	...
	//Poppets
	public static final Item poppet = Util.registerItem(new ItemPoppet(), "poppet");
	public static final Item poppet_armor = Util.registerItem(new ItemPoppet(), "poppet_armor");
	public static final Item poppet_binding = Util.registerItem(new ItemPoppet(), "poppet_binding");
	public static final Item poppet_clumsy = Util.registerItem(new ItemPoppet(), "poppet_clumsy");
	public static final Item poppet_deathprotection = Util.registerItem(new ItemPoppet(), "poppet_deathprotection");
	public static final Item poppet_earthprotection = Util.registerItem(new ItemPoppet(), "poppet_earthprotection");
	public static final Item poppet_flameprotection = Util.registerItem(new ItemPoppet(), "poppet_flameprotection");
	public static final Item poppet_hungerprotection = Util.registerItem(new ItemPoppet(), "poppet_hungerprotection");
	public static final Item poppet_judgement = Util.registerItem(new ItemPoppet(), "poppet_judgement");
	public static final Item poppet_spiritbane = Util.registerItem(new ItemPoppet(), "poppet_spiritbane");
	public static final Item poppet_tool = Util.registerItem(new ItemPoppet(), "poppet_tool");
	public static final Item poppet_vampiric = Util.registerItem(new ItemPoppet(), "poppet_vampiric");
	public static final Item poppet_voodooprotection = Util.registerItem(new ItemPoppet(), "poppet_voodooprotection");
	public static final Item poppet_voodoo = Util.registerItem(new ItemPoppet(), "poppet_voodoo");
	public static final Item poppet_wasting = Util.registerItem(new ItemPoppet(), "poppet_wasting");
	public static final Item poppet_waterprotection = Util.registerItem(new ItemPoppet(), "poppet_waterprotection");
	//Plants
